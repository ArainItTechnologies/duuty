    ...
    <div className="flex-1 overflow-y-auto">
      <div className="grid grid-cols-2 justify-items-center sm:grid-cols-2 sm:justify-center sm:max-w-[400px] sm:m-auto lg:max-w-[100%] lg:grid-cols-4 lg:justify-start gap-4">
        {[
          ...
          <div
            key={role.id}
            className={`w-full sm:w-[150px] md:w-[190px] rounded-[10px] overflow-hidden border-[2px] ${
              activeRole === role.id ? "border-indigo-600 shadow-md" : "border-gray-300 shadow-sm"

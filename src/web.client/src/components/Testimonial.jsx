    ...
    <section id="testimonials" class="testimonial-section dark:bg-gray-900 py-[50px] sm:py-[70px] md:py-[100px]">
        <div class="container-wrapper mx-auto">
            <div class="flex flex-col lg:flex-row items-center">
                ...
                <div class="max-w-[90%] sm:max-w-[100%] lg:w-1/2 lg:px-6 lg:mt-0">
                    <div className='testimonial-details lg:text-left text-center  bg-white max-w-[620px] rounded-[10px] p-[20px] sm:p-[30px] shadow-[0px_0px_12px_2px_var(--testimonial-border)]'>
                        <p class="testimonial-quotes max-w-lg text-gray-500 dark:text-gray-400 text-[16px] leading-[32px]">
                    ...
                    <div class="flex items-center justify-between mt-6 md:mt-12 justify-center lg:justify-start">
                        <button onClick={prevTestimonial} aria-label="Previous testimonial" title="left arrow" class="p-2 text-[#E6E6F3] transition-colors duration-300 border rounded-full cursor-pointer rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="#14183E" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                            </svg>
                        </button>

                        <button onClick={nextTestimonial} aria-label="Next testimonial" title="right arrow" class="p-2 text-[#E6E6F3] transition-colors duration-300 border rounded-full cursor-pointer rtl:-scale-x-100 dark:border-[#E6E6F3] dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100 prev-btn ml-[15px]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="#14183E" stroke-width="2">
